...
if (!$sub) { die("Submission not found or access denied."); }
...
<div class="card">
    <div class="alert alert-error" style="margin-bottom:0;">This student was marked <b>Absent</b> for this assignment. You may still leave a grade/feedback (e.g. "0" or "Absent") below.</div>
</div>
<?php endif; ?>
